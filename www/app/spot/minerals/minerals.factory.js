(function () {
  ...
  MineralsFactory.$inject = ['$document', '$ionicPopup', '$log'];

  function MineralsFactory($document, $ionicPopup, $log, $rootScope) {

    var mineralsInfoDescription = 
    [
      {
      "Mineral": "Actinilite",
    ...
    function getMineralInfo(name){
      return mineralsInfoDescription[4];
    } 
