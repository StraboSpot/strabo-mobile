            ...
            n = q(t).then(function (a) {
              ...
              if (c) {
                if (d.isArray(c) !== !!b.isArray) {
                  throw x("badcfg", k, b.isArray ? "array" : "object",
                    d.isArray(c) ? "array" : "object", t.method, t.url);
                }
      ...
      u.prototype = {
        setUrlParams: function (f, g, l) {
          ...
          r(m.urlParams, function (b, k) {
            ...
            d.isDefined(h) && null !== h ? (e = encodeURIComponent(h).replace(/%40/gi, "@").replace(/%3A/gi,
              ":").replace(/%24/g, "$").replace(/%2C/gi, ",").replace(/%20/g, "%20").replace(/%26/gi, "&").replace(
              /%3D/gi, "=").replace(/%2B/gi,
