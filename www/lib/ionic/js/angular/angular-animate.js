    ...
    this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout',
      ...
      function ($window, $$jqLite, $$AnimateRunner, $timeout,
        ...
        function init(element, options) {
          ...
          flags.applyTransitionDelay = truthyTimingValue(
              options.delay) && (flags.applyTransitionDuration || flags.hasTransitions);
      ...
      function ($$rAF, $rootScope, $rootElement, $document, $$HashMap,
        ...
        function queueAnimation(element, event, options) {
          ...
          if (!isValidAnimation) {
            ...
            isValidAnimation = (newAnimation.event === 'animate' && Object.keys(
                newAnimation.options.to || {}).length > 0)
