    ...
    function t() {
      if (!e.Gestures.READY) {
        ...
        for (var t in e.Gestures.gestures) {
          e.Gestures.gestures.hasOwnProperty(t) && e.Gestures.detection.register(
    ...
    e.Gestures.event = {
      ...
      handler: function (t, n) {
        if ("touchstart" == t.srcEvent.type || "touchend" == t.srcEvent.type ? this.preventedFirstMove = !1 : this.preventedFirstMove || "touchmove" != t.srcEvent.type || (n.options.prevent_default_directions.length > 0 && -1 != n.options.prevent_default_directions.indexOf(
            t.direction) && t.srcEvent.preventDefault(), this.preventedFirstMove = !0), e.Gestures.detection.current.name != this.name && this.triggered) {
          return n.trigger(
          ...
          switch (t.eventType) {
            ...
            case e.Gestures.EVENT_MOVE:
              ...
              t.drag_locked_to_axis && o !== t.direction && (e.Gestures.utils.isVertical(
                ...
                this.name + "start", t), this.triggered = !0), n.trigger(this.name, t), n.trigger(
                this.name + t.direction,
      ...
      handler: function (t, n) {
        if (e.Gestures.detection.current.name != this.name && this.triggered) {
          return n.trigger(this.name + "end",
